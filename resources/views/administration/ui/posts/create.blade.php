...
@section('title', 'Articles | Création d\'un nouvel Article')
...
@section('content')
    <header class="bg-dark text-white text-center py-3">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="display-6">Création d'un nouvel Article</h1>
    ...
    <div class="container mt-4">
        <form method="POST" action="{{ route('admin.post.add') }}" id="addPost" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="post-desc" class="form-label">Contenu d'Article:</label>
                <textarea class="form-control" id="post-desc" name="body"></textarea>
            ...
            <button type="submit" class="btn btn-primary">Créer cet Article</button>
        </form>
    </div>
                ...
                file_picker_callback: function(cb, value, meta) {
                    ...
                    input.onchange = function() {
                        ...
                        reader.onload = function() {
                            ...
                            xhr.open('POST', '{{ route('admin.upload_tinymce_posts_image') }}');
