    ...
    @section('title', 'Apropos | Création')
    @push('style')
        {{-- CSS complementaires --}}
    @endpush
    ...
    @section('content')
            ...
            <div class="container-xl">
                <div class="row g-2 align-items-center">
                    ...
                    <div class="col-auto ms-auto d-print-none">
                        <div class="d-flex">
                            <a href="{{ route('admin.about.index') }}" class="btn btn-primary text-uppercase">
        ...
        <form method="POST" action="{{ route('admin.about.add') }}" id="addAbout" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="form-title" name="title"
                            placeholder="Saisissez le titre de la rubrique">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="about-desc" name="content" rows="40" placeholder="contenu...">
                        </textarea>
                    ...
                    <div class="mb-3">
                        <div>
                            <label class="row">
                                <span class="col">Rubrique Aprouvée?</span>
                                <span class="col-auto">
    ...
    @push('script')
                    ...
                    file_picker_callback: function(cb, value, meta) {
                        ...
                        input.onchange = function() {
                            ...
                            reader.onload = function() {
                                ...
                                xhr.open('POST',
                                    '{{ route('admin.upload_tinymce_abouts_image') }}');
        ...
        <script>
            ...
            $('form#addAbout').on('submit', function(e) {
                e.preventDefault();
                toastr.remove();
