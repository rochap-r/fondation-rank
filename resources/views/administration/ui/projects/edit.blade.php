...
@section('title', 'Projets | Edition du project: ' . $project->title)
...
@section('content')
    <header class="bg-dark text-white text-center py-3">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="display-6">Edition du Projet : {{ $project->title }} </h1>
    ...
    <div class="container mt-4">
        <form method="POST" action="{{ route('admin.project.update', $project) }}" id="editProject"
                ...
                <div class="col-md-4">
                    <div class="image_holder mb-2" style="max-width: 250px;">
                        <img src="" alt="" class="img-thumbnail" id="image-previewer"
                            data-ijabo-default-img="{{ $project->image
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control " id="goal" name="goal" value="{{ $project->goal }}">
            ...
            <div class="mb-3">
                ...
                <select class="form-select mb-3" id="type_project" name="type_project_id">
                    ...
                    @foreach (\App\Models\TypeProject::all() as $type)
                        <option {{ $project->typeProject->id == $type->id ? 'selected' : '' }} value="{{ $type->id }}">
                            {{ $type->name }}</option>
                    @endforeach
                </select>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="project-desc" name="description">
                    {!! $project->description !!}
                </textarea>
...
@push('script')
    <script>
        ...
        $('form#editProject').on('submit', function(e) {
            e.preventDefault();
            toastr.remove();
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.code === 1) {
                        ...
                        tinymce.get('project-desc').setContent(response.description);
