              ...
              <div class="nav-bar">
                <nav>
                  <ul>
                    ...
                    <li><a href="projects.html">La fondation</a>
                      <ul>
                        <li><a href="index-4.html">Missions, Objectifs, Valeurs</a></li>
                        <li><a href="index.html">Conseil d'Administration</a></li>
                        <li><a href="index-2.html">Documents Officiels</a></li>
                      </ul>
                    </li>
                    <li><a href="projects.html">Nos projets</a>
                      <ul>
                        <li><a href="ukatesh-university.html">Université Ukatesh</a></li>
                        <li><a href="rural-development.html">Développement rural</a></li>
                      </ul>
                    </li>
      ...
      <ul>
        ...
        <li class="menu-item-has-children"><a href="JavaScript:void(0)">Actualités</a>
          ...
          <ul class="sub-menu">
            ...
            <li><a href="ukatesh-university.html">Evenements</a></li>
            <li><a href="rural-development.html">Actualités</a></li>
          </ul>
