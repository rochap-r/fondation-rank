        ...
        <div class="container-xl">
            ...
            <div class="navbar-nav flex-row order-md-last">
                <div class="d-none d-md-flex">
                    <a href="{{ url()->current() }}?theme=dark" class="nav-link px-0 hide-theme-dark"
                    ...
                    <a href="{{ url()->current() }}?theme=light" class="nav-link px-0 hide-theme-light"
                        ...
                        <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end dropdown-menu-card">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Dernières infos</h3>
                                </div>
                                <div class="list-group list-group-flush list-group-hoverable">
                                    <div class="list-group-item">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col text-truncate">
                                                <a href="#" class="text-body d-block">Exemple 1</a>
                                    ...
                                    <div class="list-group-item">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col text-truncate">
                                                <a href="#" class="text-body d-block">Exemple 2</a>
                                                <div class="d-block text-muted text-truncate mt-n1">
                                                    Top merci pour les derniers infos
                                                </div>
                                            </div>
                                            <div class="col-auto">
